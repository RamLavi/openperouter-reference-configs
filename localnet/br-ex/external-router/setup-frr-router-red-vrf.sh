...
# Put eth1 (external client network) in VRF red.
# eth0 = underlay (10.100.x.x) stays in default VRF for BGP peering.
# eth1 = isolated client network (192.169.1.x) goes in VRF red for L3 routing.
